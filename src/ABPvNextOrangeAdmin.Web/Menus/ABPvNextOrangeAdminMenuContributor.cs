...
namespace ABPvNextOrangeAdmin.Web.Menus;

public class ABPvNextOrangeAdminMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ABPvNextOrangeAdminMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<ABPvNextOrangeAdminResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                ABPvNextOrangeAdminMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
