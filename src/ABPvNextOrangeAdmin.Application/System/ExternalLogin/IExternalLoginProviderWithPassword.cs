...
public interface IExternalLoginProviderWithPassword
{
    ...
    Task<SysUser> CreateUserAsync(string userName, string providerName, string plainPassword);
    ...
    /// <param name="plainPassword">The plain password of the user</param>
    Task UpdateUserAsync(SysUser user, string providerName, string plainPassword); 
}